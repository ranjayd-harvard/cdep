...
const MIGRATIONS_TABLE = "subscription_schema_migrations";

// Resolves the migrations/ directory relative to a caller's __dirname —
// same two-depth trick as data-exchange-service/data-product-catalog-service
// (tsx in dev vs. compiled dist/scripts in the Docker image).
