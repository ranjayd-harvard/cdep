...
export type Permission = "operations.read";

const PERMISSIONS_BY_ROLE: Record<Role, readonly Permission[]> = {
  CUSTOMER_ADMIN: ["operations.read"],
  CUSTOMER_USER: ["operations.read"],
  CUSTOMER_READONLY: ["operations.read"],
  PRODUCT_CONSUMER: ["operations.read"],
  PRODUCT_OWNER: ["operations.read"],
  DATA_STEWARD: ["operations.read"],
  PLATFORM_OPERATOR: ["operations.read"],
  SECURITY_ADMIN: ["operations.read"],
  PLATFORM_ADMIN: ["operations.read"],
  SERVICE: ["operations.read"],
  OBSERVABILITY_ADMIN: ["operations.read"],
  OBSERVABILITY_READER: ["operations.read"],
};
