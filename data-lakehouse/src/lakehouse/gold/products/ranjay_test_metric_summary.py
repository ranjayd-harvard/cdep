"""`ranjay-test-metric-summary` Gold Data Product.
...
Derives `metric_value_doubled = metric_value * 2` from `silver.ranjay_test_metric`,
...
GOLD_RANJAY_TEST_METRIC_SUMMARY_SCHEMA = pa.schema(
    [
...
GOLD_RANJAY_TEST_METRIC_SUMMARY_GRAIN_KEY = ["organization_id", "tenant_id", "metric_id"]
...
def build_ranjay_test_metric_summary(silver_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    records = []
