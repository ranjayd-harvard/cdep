-- Seeds the "ranjay-test-metric-summary" Gold Data Product row so it's visible
...
--   docker exec -i data-lakehouse-postgres-1 psql -U lakehouse -d lakehouse < sql/004_ranjay_test_metric_summary_seed.sql

INSERT INTO lakehouse.data_products (
    data_product_id, display_name, version, gold_table, owner, description, status
) VALUES (
    'ranjay-test-metric-summary', 'Ranjay Test Metric Summary', '1.0', 'gold.ranjay_test_metric_summary',
    'Platform Test', 'Synthetic Ranjay test Gold Data Product used to validate onboarding a brand-new data product end-to-end.', 'ACTIVE'
)
