...
// Protects all /internal/v1/* routes — shared static key, same convention
// as subscription-service's requireInternalAuth. In AUTH_MODE=development,
// a missing key falls back to a fixed dev actor so local curl/scripts/demo
// work without hand-crafting headers.
