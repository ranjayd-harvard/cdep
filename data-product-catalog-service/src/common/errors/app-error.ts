...
const STATUS_BY_CODE: Record<ErrorCode, number> = {
  ...
  VERSION_BUMP_MISMATCH: 422,
  VERSION_ALREADY_EXISTS: 409,
  VERSION_NOT_ACTIVATABLE: 409,
  VERSION_NOT_RETIRABLE: 409,
  INVALID_VERSION_TRANSITION: 409,
  VERSION_APPROVAL_REQUIRED: 409,
  VERSION_REQUIRES_BETA_OPT_IN: 403,
  VERSION_RETIRED_UNRESOLVABLE: 410,
  NO_COMPATIBLE_VERSION: 422,
  IDEMPOTENCY_KEY_REUSED: 409,
  MIGRATION_REQUIRES_MANUAL_ACTION: 422,
